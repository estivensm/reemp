...
ActiveRecord::Schema.define(version: 2019_03_27_155146) do
  ...
  create_table "reempers_subspecialties", id: false, force: :cascade do |t|
    t.bigint "reemper_id", null: false
    t.bigint "subspecialty_id", null: false
  end
